    ...
    try {
      ...
      if (response.data && response.data.success) {
        ...
        return { 
          success: true, 
          data: response.data,
          isPasswordChanged: normalizedUser.IsPasswordChanged ?? normalizedUser.isPasswordChanged
        };
      }
      ...
      return { 
        success: false, 
        message: err.message || err.response?.data?.message || 'Invalid credentials or network error.' 
      };
    }
  };
