  ...
  return (
    <aside className="w-64 bg-slate-800 text-slate-300 flex flex-col h-screen">
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
        <Link
          to="/dashboard"
          className="block px-4 py-2.5 rounded hover:bg-slate-700 hover:text-white transition"
        >
          Dashboard
        </Link>
        <Link
      ...
      <div className="p-4 border-t border-slate-700">
        <button
          ...
          className="w-full bg-red-600 hover:bg-red-700 text-white py-2 rounded transition text-center text-sm font-medium cursor-pointer"
        >
          Logout
        </button>
      </div>
