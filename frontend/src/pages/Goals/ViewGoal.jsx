    ...
    <div className="flex-1 bg-gray-50 min-h-screen overflow-y-auto p-4 sm:p-8">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-10 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-6 border-b">
          <button
            onClick={() => navigate(-1)}
            className="text-sm text-indigo-600 hover:text-indigo-800 font-semibold flex items-center cursor-pointer"
          >
            &larr; Back
          </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white p-5 rounded-xl border border-gray-100 shadow-xs">
            <h4 className="font-semibold text-gray-800 mb-2 text-sm uppercase tracking-wider">
              Goal Description
            </h4>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-emerald-50/50 p-5 rounded-xl border border-emerald-100">
            <h4 className="font-semibold text-emerald-900 mb-2 text-sm uppercase tracking-wider">
              Meet Performance
            </h4>
          ...
          <div className="bg-indigo-50/50 p-5 rounded-xl border border-indigo-100">
            <h4 className="font-semibold text-indigo-900 mb-2 text-sm uppercase tracking-wider">
              Exceed Performance
            </h4>
                ...
                return (
                  ...
                  >
                    <button
                      type="button"
                      onClick={() =>
                        setExpandedQuarter(isOpen ? null : update.Quarter)
                      }
                      ...
                      <div className="p-4 border-t border-gray-100 bg-gray-50 space-y-2">
                        <div>
                          ...
                          <p className="text-sm text-gray-700 mt-0.5">
                            {update.Achievements || "None recorded."}
                          </p>
                        </div>
                        <div>
                          <span className="text-xs font-semibold text-gray-500 uppercase">
                          ...
                          <p className="text-sm text-gray-700 mt-0.5">
                            {update.Challenges || "None recorded."}
                          </p>
                        </div>
                        {update.EvidenceUrl && (
                          <div>
            ...
            <div className="space-y-3">
              {goal.SubGoals
                ...
                <div
                  ...
                  className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 border rounded-xl bg-white shadow-xs gap-2"
                >
                  <div>
                    <span className="text-xs font-bold text-indigo-600 uppercase">
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  {goal.ReviewedDate && (
                    <span className="text-xs text-gray-500">
                      Reviewed on{" "}
                      {new Date(goal.ReviewedDate).toLocaleDateString()}
                    </span>
                  )}
                </div>
